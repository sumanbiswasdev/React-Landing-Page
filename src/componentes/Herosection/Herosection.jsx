            ...
            <div className="absolute inset-0 flex justify-between items-center mx-5">
                <button onClick={prevSlide} className="bg-white rounded-full p-2 cursor-pointer text-2xl"><IoIosArrowBack /></button>
                    <div className="text-center text-white ">
                        ...
                        <button className="cursor-pointer px-5 py-4 bg-white rounded-full font-medium md:text-[16px] text-black
                         hover:bg-[#e8e8ef] transition-all ease-in-out duration-300">{heroData[current].btn}</button>
                    </div>
